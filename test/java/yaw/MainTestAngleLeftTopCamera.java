...
public class MainTestAngleLeftTopCamera {
    public static void main(String[] args) throws Exception {
      ...
      /*  world.getCamera().translate(-10, 10, -10);
        world.getCamera().rotate(-45,-135,0);*/
        world.getCamera().translate(-15, 15, -10);
        world.getCamera().rotate(-45,-90,0);
        ...
        while (true) {
            ...
            Thread.sleep(200); /* Allows to see the block (cube) move at constant rate. */
        }
    }
