...
(defn the-group
  ...
  [:group :test/group {:pos (:pos @state)
   ...
   [:hitbox :test/hitbox {:pos [0 0 -5]
                          :scale 0.6
                          :length [1 1 1]}
    [{:group-id :test/group2 :hitbox-id :test/hitbox2 :collision-handler #(println "collision")}]]])
  ...
  [:scene
   ...
   [:group :test/group2 {:pos [0 0 0]
    ...
    [:item :test/box2 {:mesh :mesh/box
                       ...
                       :mat :red
                       :scale 0.3}]
    [:hitbox :test/hitbox2 {:pos [1.5 0 -5]
                            :scale 0.6
                            :length [1 1 1]}]]
   [the-group cube-state]])
